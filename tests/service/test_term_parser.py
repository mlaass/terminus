...
import unittest
from service.term_parser import *
...
class TestParserMethods(unittest.TestCase):
    def test_tokenize_simple_case(self):
        ...
        self.assertEqual(tokenize(input_expression), expected_tokens)
    ...
    def test_parse_to_tree_simple_binary_expression(self):
        ...
        self.assertEqual(parse_to_tree(expression), expected_tree)
    ...
    def test_shunting_yard_complex_expression_with_function_calls(self):
        tokens = tokenize("(addDays(startDate, 10) < addDays(endDate, -5)) and not userActive")
        expected_rpn = [
        ...
        self.assertEqual(shunting_yard(tokens), expected_rpn)
